...
const COLORS = ['#065f46', '#c9a94e', '#22c55e', '#ef4444', '#8b5cf6', '#f97316', '#06b6d4', '#ec4899'];
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          {/* Selected month — aggregated only, no individual reviews */}
                  ...
                  .map((item) => (
                    <div key={item.food_item_id} className="flex items-center gap-3 py-1">
                      ...
                      <div className="flex-1 bg-gray-100 rounded-full h-3 overflow-hidden">
                        <div className="bg-emerald-600 h-full rounded-full" style={{ width: `${(item.average / 5) * 100}%` }} />
                      </div>
